function csc_electrodes
% Function to create and save the file CSG_electrodes.mat used by FASST. 
% This should allow an easier reviewing editing of the channel 
% characteristics for other users.
%
% The CSG_electrodes.mat file containes 6 variables, summarizing any
...
Pelec = [spm_str_manip(which('csg_main'),'h'),filesep,'CSG_electrodes.mat'];
save(Pelec,'Rxy','Nchannels','names','pos','crc_types','Cpos','Dchan');
